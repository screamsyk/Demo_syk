...
//---ES8：2017年，ECMAScript8.0发布
//---ES9：2018年6月底，ECMAScript9.0发布，改进了正则表达式

//(4)ECMAScript是JavaScript的基础标准部分，ES6是目前多数浏览器都支持的标准，而ES9是它的最新一代的标准
...
//(7)注意ES6模块的运行机制与CommonJS不一样，它遇到模块加载命令import时，不会去执行模块，而是只生成一个动态的只读引用。等到真的需要用到时，再到模块里面去取值